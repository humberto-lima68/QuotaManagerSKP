...
sap.ui.define([
	...
	"exed/com/quotamanagerskp/model/formatter",
	"sap/ui/Device",
	...
	return BaseController.extend("exed.com.quotamanagerskp.controller.Detail", {
	...
	//		this.getView().byId("page").setTitle("Carteira SKP" + " - " + "(" + iZusergc + ")");
		...
		onSearch: function (oEvent) {
			...
			var filter1 = new sap.ui.model.Filter("Zuname", sap.ui.model.FilterOperator.EQ, iZusergc);
